...
- [Reactive Signals](02-reactive-signals.md) — ReactiveNode, Link, propagation, batching, diamond resolution, deep signals, line-by-line through propagate(), checkDirty(), link(), unlink(), deep() Proxy
...
- [Rendering, Signals & SSE](17-rendering-signals-deep-dive.md) — Complete lifecycle from server to browser, rendering pipeline, retry logic
